...
CREATE TABLE IF NOT EXISTS `ORGANIZATION_EVENT` (
    `ID` INT PRIMARY KEY AUTO_INCREMENT,
    `ORGANIZATION_UID` BINARY(16),
    `VERSION` INT,
    `CREATED_DATE` DATETIME,
    `EVENT` JSON
);

CREATE INDEX `ORGANIZATION_EVENT_ORGANIZATION_UID_INDEX` ON `ORGANIZATION_EVENT` (`ORGANIZATION_UID`);
...
CREATE INDEX `ORGANIZATION_READ_UID_UNIQUE_INDEX` ON `ORGANIZATION_READ` (`UID`);
...
ALTER TABLE `USER_READ` ADD COLUMN `EMAIL` VARCHAR(255) AFTER `USERNAME`;
ALTER TABLE `USER_READ` ADD COLUMN `ROLE` VARCHAR(255) AFTER `PASSWORD`;
ALTER TABLE `USER_READ` ADD COLUMN `STATUS` VARCHAR(255) AFTER `ROLE`;
ALTER TABLE `USER_READ` ADD COLUMN `NAME` VARCHAR(255) AFTER `STATUS`;
ALTER TABLE `USER_READ` ADD COLUMN `GENDER` VARCHAR(255) AFTER `NAME`;
ALTER TABLE `USER_READ` ADD COLUMN `BIRTH_DATE` DATE AFTER `GENDER`;
ALTER TABLE `USER_READ` ADD COLUMN `ORGANIZATION_UID` BINARY(16) AFTER `BIRTH_DATE`;
ALTER TABLE `USER_READ` ADD COLUMN `INVITATION_CODE` INT AFTER `ORGANIZATION_UID`;
ALTER TABLE `USER_READ` ADD COLUMN `RESET_PASSWORD_CODE` INT AFTER `INVITATION_CODE`;

ALTER TABLE `ORGANIZATION_READ` ADD COLUMN `TYPE` VARCHAR(255) AFTER `STATUS`;
ALTER TABLE `ORGANIZATION_READ` ADD COLUMN `TOTAL_MEMBER` VARCHAR(255) AFTER `TYPE`;
ALTER TABLE `ORGANIZATION_READ` ADD COLUMN `PROVINCE` VARCHAR(255) AFTER `TOTAL_MEMBER`;
ALTER TABLE `ORGANIZATION_READ` ADD COLUMN `CITY` VARCHAR(255) AFTER `PROVINCE`;