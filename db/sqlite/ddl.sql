...
CREATE INDEX IF NOT EXISTS "DEVICE_EVENT_DEVICE_UID_INDEX" ON "DEVICE_EVENT" ("DEVICE_UID");
...
CREATE INDEX IF NOT EXISTS "DEVICE_READ_UID_UNIQUE_INDEX" ON "DEVICE_READ" ("UID");
